...
def populate_data():
    # Extended Task Data
    tasks_data = [
        Task(name="Learn Python basics", completed=True, deadline="2024-10-01"),
        Task(name="Build a Flask API", completed=False, deadline="2024-10-02"),
        Task(name="Study JavaScript fundamentals", completed=True, deadline="2024-10-03"),
        Task(name="Learn advanced JavaScript concepts", completed=False, deadline=""),
        Task(name="Refactor existing codebase", completed=True, deadline="2024-11-01"),
        Task(name="Deploy application on cloud", completed=False, deadline="2024-11-03"),
        Task(name="Handle missing data gracefully", completed=False, deadline=None),  # Edge case: missing date
        Task(name="Explore serverless architecture", completed=True, deadline="2025-01-10"),
        Task(name="Write unit tests", completed=False, deadline="2025-02-05"),
        Task(name="Optimize database queries", completed=True, deadline="2025-02-12"),
        Task(name="Work on a collaborative project", completed=False, deadline="2024-12-31"),
    ]
